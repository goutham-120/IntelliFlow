        ...
        return (
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              {canEditTasks ? (
                <select
                  ...
                  className="rounded-lg border border-slate-700 bg-slate-900 px-2 py-1 text-xs uppercase text-slate-300 disabled:opacity-60 sm:px-2.5 sm:py-1.5"
                >
                ...
                <span className="rounded-lg border border-slate-700 bg-slate-900 px-2 py-1 text-xs uppercase text-slate-300 sm:px-2.5 sm:py-1.5">
                  {task.status}
                </span>
              )}
              <Link
                to={`/tasks/${task._id}`}
                className="rounded-lg border border-emerald-400/30 bg-emerald-500/10 px-2 py-1 text-xs font-medium text-emerald-200 transition hover:bg-emerald-500/16 sm:px-3 sm:py-1.5"
              >
          ...
          <div className="flex flex-wrap gap-1.5 text-xs text-slate-300 sm:gap-2">
            {[
              ...
              <span key={label} className="rounded-lg border border-slate-700 bg-slate-900/70 px-2 py-0.5 sm:px-2.5 sm:py-1">
                {label}
              </span>
            ))}
          </div>
