      ...
      >
        <div className="flex min-w-0 items-center gap-4">
          ...
          <div className="min-w-0">
            <p className={`hidden sm:block text-[11px] font-semibold uppercase tracking-[0.24em] ${isLightTheme ? "text-slate-400" : "text-slate-500"}`}>
              Command Center
            </p>
            <div className="flex items-center gap-2">
              <h2 className="font-display text-base font-bold sm:text-xl">{pageTitle}</h2>
              <span
