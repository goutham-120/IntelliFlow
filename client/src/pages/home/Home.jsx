    ...
    >
      ...
      >
        ...
        >
          {/* Left */}
          <div>
            <div className="section-label u0">
              Workflow & Performance Platform
            </div>
            <h1
              className="u1"
              style={{
            ...
            {[
              {
                ...
                desc: "Multi-stage pipelines with custom approval hierarchies.",
              },
              {
                icon: "📌",
                title: "Task Tracking",
                desc: "Full status visibility across every request and stage.",
              },
              {
                icon: "⏱",
                title: "Stage Visibility",
                desc: "Spot stalled requests and handoffs before work slows down.",
              },
              {
                icon: "🛡",
                title: "Audit Logs",
                desc: "Immutable record of every action for compliance.",
              },
              {
                icon: "📊",
                title: "Analytics",
                desc: "Measure bottlenecks and workload distribution.",
              },
              {
                icon: "🏢",
                title: "Multi-Tenant",
                desc: "Isolated orgs with separate users and data.",
              },
            ].map((f, i) => (
              <div
                key={i}
            ...
            {[
              {
                ...
                body: "Map out stages, assign responsible teams, and set clear ownership for every step.",
              },
              {
                n: "02",
                title: "Track in real time",
                body: "Requests move through your pipeline automatically. Every stakeholder sees current status instantly.",
              },
              {
                n: "03",
                title: "Analyze and improve",
                body: "Spot bottlenecks, measure throughput, and continuously refine based on real performance data.",
              },
            ].map((s, i) => (
              <div
                key={i}
